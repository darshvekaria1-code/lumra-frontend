...
type LaptopIntroProps = {
  onComplete: () => void
  children: React.ReactNode // The landing page content to show inside
}

export default function LaptopIntro({ onComplete, children }: LaptopIntroProps) {
      ...
      {isLaptopVisible && (
        ...
        >
          ...
          >
            ...
            >
              {/* Laptop Lid/Screen - Fully closed when stage is "closed" */}
              <motion.div
                className="absolute"
                style={{
                  width: "800px",
                ...
                >
                  ...
                  {stage !== "closed" && (
                    ...
                    <AnimatePresence mode="wait">
                      {/* Landing page content inside screen - only when open */}
                      {(stage === "open" || stage === "zooming" || stage === "fading") && (
                        <motion.div
                          key="content"
                          initial={{ opacity: 0 }}
                          animate={{ opacity: 1 }}
                          ...
                          style={{
                            transform: stage === "zooming" || stage === "fading" 
                              ? "scale(1)" 
                              : "scale(0.25)",
                            transformOrigin: "top left",
                            width: stage === "zooming" || stage === "fading" ? "100%" : "400%",
                            height: stage === "zooming" || stage === "fading" ? "100%" : "400%",
                            position: "relative",
                            zIndex: 1
                          }}
                      ...
                      {/* Closed screen - completely black */}
                      {stage === "closed" && (
                        <motion.div
                          key="closed"
                          initial={{ opacity: 1 }}
